...
import { sectionPaperSx } from '../../components/layout/DetailPagePrimitives'
  ...
  return (
    <Box sx={{ maxWidth: '100%' }}>
      ...
      <PageHero
        ...
        title="Issue new ATW"
        subtitle="Authorize a trucker to withdraw containers that are currently in CY inventory at the selected yard."
      />
